...
{
	SetCastShadow(false);
	MuzzleOffset = FVector(100.0f, 0.0f, 60.0f);
}

void UWeaponBaseComponent::AttachWeapon(APlayerCharacter* TargetCharacter)
{
	...
	if (APlayerController* PlayerController = Cast<APlayerController>(Character->GetController()))
	{
		...
		{
			// Fire
			EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this, &UWeaponBaseComponent::Fire);
		}
	}
